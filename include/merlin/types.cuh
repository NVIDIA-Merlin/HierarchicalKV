...
/**
 * An abstract file provides interface between the nv::merlin::HashTable
...
class BaseKVFile {
 public:
   ...
   *
   * @return Upon successful read, return number of kv pairs have been read.
             Ootherwise -1 is returned.
   */
   ...
   * @return Upon successful write, return number of kv pairs have been written.
